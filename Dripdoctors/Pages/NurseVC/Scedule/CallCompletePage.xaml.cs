...
{
	public partial class CallCompletePage : ContentPage
	{
		Call selectedCall = null;
		private CallCompletePage()
		{
			InitializeComponent();
			NavigationPage.SetHasNavigationBar(this, false);
			backButton.Clicked += (sender, e) => { Navigation.PopAsync();};
			rightButton.Clicked += (sender, e) => { };
			completedLabel1.Text = AppResources.CallCompletedSentence1;
			completedLabel2.Text = AppResources.CallCompletedSentence2;
		...
		public CallCompletePage(Call call) : this() {
			selectedCall = call;

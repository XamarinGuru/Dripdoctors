...
string JSONS, isArray, isEmpty, keyPath, root, stringHasISO8601DateSignature;
...
keyPath = function(object, keypath) {
  string current_object, i, key, keypath_components, l;
...
JSONS.serialize = function(obj, options) {
  string key, result, value, _i, _len;
...
JSONS.deserialize = function(json, options) {
  string constructor_or_root, date, instance, json_as_JSON, json_type, key, namespace_root, result, type, value, _i, _j, _len, _len1, _ref;
